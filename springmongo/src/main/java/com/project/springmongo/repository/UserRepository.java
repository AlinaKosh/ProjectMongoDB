...
public interface UserRepository extends MongoRepository<User, String> {
    ...
    //вывести всех пользователей у которых имя Lana
    @Aggregation("{ $match : { 'username' : 'Lana' } }")
    List<User> findUsersWithNameLana();
    ...
    @Aggregation("{ $match : { 'username' : { $regex: '^S' } } }")
    List<User> findUsersNameStartsWithS();
